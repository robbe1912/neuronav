...
ALLOWED[("nav.py", 537)] = "config walk filter (EXTS = user config; all_suffixes=#240 census)"
ALLOWED[("nav.py", 593)] = "parametric walk filter (caller-supplied suffixes)"
ALLOWED[("nav.py", 624)] = "config walk filter (EXTS = user config)"
