...
ALLOWED[("nav.py", 484)] = "config walk filter (EXTS = user config)"
ALLOWED[("nav.py", 514)] = "parametric walk filter (caller-supplied suffixes)"
ALLOWED[("nav.py", 544)] = "config walk filter (EXTS = user config)"
