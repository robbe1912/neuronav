...
ALLOWED[("nav.py", 474)] = "config walk filter (EXTS = user config)"
ALLOWED[("nav.py", 504)] = "parametric walk filter (caller-supplied suffixes)"
ALLOWED[("nav.py", 534)] = "config walk filter (EXTS = user config)"
